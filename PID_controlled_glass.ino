...
PIDextras enclosureValues(4.0, 100.0, 20.0, enclosureTemperature.setpoint, 55.0,58.0,25.0,1);
...
void setup()
{
  ...
  enclosurePID.SetSampleTime(60000); 
  enclosurePID.SetOutputLimits(32, enclosureValues.maxOutputNormal); 
